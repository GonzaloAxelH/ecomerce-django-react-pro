...
const Shop: FC<Props> = ({ get_categories, categories }) => {
                            ...
                            return (
                              ...
                              >
                                <input
                                  name="category_id"
                                  type="radio"
                                  className="focus:ring-blue h-4 w-4 text-blue-600 border-gray-300 rounded-full"
                                />
